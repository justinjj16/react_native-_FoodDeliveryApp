...
const Restaurant =({route,navigation})=>{
    ...
    function returnDote(){
        const dotPossotion = Animated.divide(scrollX,SIZES.width)
        return(
            <View style={{height:30}}>
                ...
                >
                    {restaurant?.menu.map((item,index)=>{
                        const opacity = dotPossotion.interpolate({
                            inputRange:[index -1,index,index +1],
                            outputRange:[0.3,1,0.3],
                            extrapolate:'clamp'
                        })
                        const dotSize = dotPossotion.interpolate({
                            inputRange:[index -1,index,index +1],
                            outputRange:[SIZES.base * 0.8,10,SIZES.base * 0.8],
                            extrapolate:'clamp'
                        })
                        const dotColor = dotPossotion.interpolate({
                            inputRange:[index -1,index,index +1],
            ...
            <View>
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        onPress={()=>navigation.navigate("OrderDeliverys",{
                            restaurant,
                            currentLocation
                        })}
                        >
